...
export const CATEGORIES: Category[] = [
  { id: "camisetas-dama",  label: "Camisetas Dama",   price: 25000, kw: ["camiseta","camisetas-dama"] },
  { id: "blusas-dama",     label: "Blusas Dama",      price: 30000, kw: ["blusa","blusas","blusa-dama"] },
  { id: "bodies-dama",     label: "Bodies Dama",      price: 30000, kw: ["body","bodies","body-dama"] },
  { id: "conjuntos-dama",  label: "Conjuntos Dama",   price: 50000, kw: ["conjunto","conjuntos-dama"] },
  { id: "enterizos-dama",  label: "Enterizos Dama",   price: 60000, kw: ["enterizo","jumpsuit"] },
  { id: "conjunto-ninas",  label: "Conjunto Niñas",   price: 45900, kw: ["nina","niña","conjunto-nina"] },
  { id: "conjunto-ninos",  label: "Conjunto Niños",   price: 44900, kw: ["nino","niño","conjunto-nino"] },
  { id: "familia",         label: "Familia",          price: 58900, kw: ["familia","family"] },
  { id: "pareja",          label: "Pareja",           price: 25000, kw: ["pareja","couple"] },
...
export const TESTIMONIALS = [
  ...
  { name: "Sofía Herrera",    city: "Bello, Antioquia",       stars: 5, avatar: "🧕",     text: "Siempre encuentro lo que busco aquí. Los precios son muy buenos y la calidad supera las expectativas. ¡Mi tienda favorita!" },
  { name: "Catalina Zapata",  city: "Sabaneta, Antioquia",    stars: 5, avatar: "👩‍🦳", text: "Me encanta la variedad de estilos. La atención es personalizada, ¡como si fuera tu amiga de toda la vida!" },
  { name: "Isabella Morales", city: "La Estrella, Antioquia", stars: 5, avatar: "👩",     text: "Pedí una blusa y llegó perfecta, el color idéntico a la foto. El empaque muy cuidadoso. ¡Gracias!" },
];
...
export function parseFilename(filename: string, idx: number): Product {
  ...
  const name  = base.replace(/\$[\d.,]+/g, "").replace(/[-_]/g, " ").replace(/\s+/g, " ").trim().replace(/\b\w/g, (c) => c.toUpperCase()) || "Prenda Femenina";
